  ...
  return (
    <section className="profile">
      <div className="profile__left">
        ...
        <div className="profile__medium">Oil Painting, Photography, Video</div>
        <div className="profile__style">Surrealism, Abstract, Weird Shit</div>
        <div className="profile__bio">
          My work is a mixture of lorem ipsum and whatever all the things. I've
          been based in Vancouver my whole life and am very excited to start
          creating sculptures out of tinfoil
        </div>
